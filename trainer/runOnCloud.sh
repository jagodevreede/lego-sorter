...
ssh -L localhost:9101:localhost:9100 -L localhost:9835:localhost:9835 $USERNAME@$1 'cd lego; /home/$USERNAME/.sdkman/candidates/java/17.0.3.6.1-amzn/bin/java -jar trainer-1.0.0-SNAPSHOT-shaded.jar'
