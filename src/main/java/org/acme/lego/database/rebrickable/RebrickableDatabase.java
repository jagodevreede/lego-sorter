...
public class RebrickableDatabase {
    ...
    private static final List<String> REBRICKABLE_DB_FILES = List.of("colors.csv", "inventories.csv", "inventory_parts.csv", "minifigs.csv", "part_relationships.csv", "sets.csv",
